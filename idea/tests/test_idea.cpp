...
namespace crypto::test {
    ...
    TEST_F(CryptoTest, ECB_PKCS7_DataEncryption) {
        auto idea = std::make_shared<crypto::IDEACipher>();
        idea->set_round_keys(test_key);

        CryptoContext context(idea, mode::CipherMode::ECB, mode::PaddingMode::PKCS7);
    ...
    TEST_F(CryptoTest, CBC_ANSI_X923_DataEncryption) {
        ...
        CryptoContext context(idea, mode::CipherMode::CBC, mode::PaddingMode::ANSI_X923, test_iv);
    ...
    TEST_F(CryptoTest, PCBC_ISO_10126_DataEncryption) {
        ...
        CryptoContext context(idea, mode::CipherMode::PCBC, mode::PaddingMode::ISO_10126, test_iv);
    ...
    TEST_F(CryptoTest, CFB_Zeros_DataEncryption) {
        ...
        CryptoContext context(idea, mode::CipherMode::CFB, mode::PaddingMode::Zeros, test_iv);
        auto encrypted = context.encrypt_async(test_data_2000).get();
        auto decrypted = context.decrypt_async(encrypted).get();
    ...
    TEST_F(CryptoTest, OFB_PKCS7_DataEncryption) {
        ...
        CryptoContext context(idea, mode::CipherMode::OFB, mode::PaddingMode::PKCS7, test_iv);
    ...
    TEST_F(CryptoTest, CTR_ANSI_X923_DataEncryption) {
        ...
        CryptoContext context(idea, mode::CipherMode::CTR, mode::PaddingMode::ANSI_X923, test_iv);
    ...
    TEST_F(CryptoTest, RandomDelta_ISO_10126_DataEncryption) {
        ...
        CryptoContext context(idea, mode::CipherMode::RandomDelta, mode::PaddingMode::ISO_10126);
    ...
    TEST_F(CryptoTest, CBC_PKCS7_TextFileEncryption) {
        ...
        CryptoContext context(idea, mode::CipherMode::CBC, mode::PaddingMode::PKCS7, test_iv);
    ...
    TEST_F(CryptoTest, ECB_ANSI_X923_ImageEncryption) {
        ...
        CryptoContext context(idea, mode::CipherMode::ECB, mode::PaddingMode::ANSI_X923);
